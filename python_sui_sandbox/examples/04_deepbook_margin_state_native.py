...
OBJECTS = {
    ...
    # 0x97d947...::margin_registry::MarginRegistry
    "margin_registry": "0x0e40998b359a9ccbab22a98ed21bd4346abf19158bc7980c8291908086b3a742",
    # 0x8d97f1...::price_info::PriceInfoObject (SUI oracle)
    "sui_pyth_oracle": "0x801dbc2f0053d34734814b2d6df491ce7807a725fe9a01ad74a07e9c51396c37",
    # 0x8d97f1...::price_info::PriceInfoObject (USDC oracle)
    "usdc_pyth_oracle": "0x5dec622733a204ca27f5a90d8c2fad453cc6665186fd5dff13a83d0b6c9027ab",
    # 0x2c8d60...::pool::Pool<SUI, USDC>
    "deepbook_pool": "0xe05dafb5133bcffb8d59f4e12465dc0e9faeaa05e3e342a08fe135800e3e4407",
    # 0x97d947...::margin_pool::MarginPool<SUI>
    "base_margin_pool": "0x53041c6f86c4782aabbfc1d4fe234a6d37160310c7ee740c915f0a01b7127344",
    # 0x97d947...::margin_pool::MarginPool<USDC>
...
OBJS = [
    ...
    OBJECTS["sui_pyth_oracle"],
    OBJECTS["usdc_pyth_oracle"],
    OBJECTS["deepbook_pool"],
    OBJECTS["base_margin_pool"],
    OBJECTS["quote_margin_pool"],
    OBJECTS["clock"],
]

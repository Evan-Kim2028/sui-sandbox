...
echo "[python-smoke] Syntax check examples 01/02/03/04/06"
...
"$PYTHON_BIN" -m py_compile python_sui_sandbox/examples/04_generic_flow_native.py
"$PYTHON_BIN" -m py_compile python_sui_sandbox/examples/06_deepbook_margin_state_native.py
...
echo "[python-smoke] Offline CLI parse checks for examples 01/03/04/06"
...
"$PYTHON_BIN" python_sui_sandbox/examples/04_generic_flow_native.py --help >/dev/null
"$PYTHON_BIN" python_sui_sandbox/examples/06_deepbook_margin_state_native.py --help >/dev/null

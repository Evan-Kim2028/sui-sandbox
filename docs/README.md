...
Use this as the docs entrypoint. Pick the depth you need.

## Level 0: Explain It Fast (2 minutes)

- What this is and how it differs from other tooling:
  - [START_HERE.md](START_HERE.md)

## Level 1: Start Using It (5-15 minutes)

- Root overview + quick command examples:
  - [../README.md](../README.md)
...
## Level 2: Core Workflows (15-30 minutes)
